...
public class ControladorPresentacio {
	 ...
	 * @param nom de l'autor a afegir
	 * @param label que tindrÃ  l'autor
	 * @return el seu identificador intern
	 * @throws IOException si hi ha un error invalidant clausures
	 */
	...
	/**
	 * Afegeix una conferÃ¨ncia al graf actual sense cap etiqueta i retorna el seu identificador intern.
	...
	/**
	 * Afegeix una conferÃ¨ncia al graf actual i retorna el seu identificador intern.
	 * @param nom de la conferencia a afegir
	 * @param label que tindrÃ  la conferencia
	 * @return el seu identificador intern
	 * @throws IOException si hi ha un error invalidant clausures
	 */
	 ...
	 * LlenÃ§ara una excepciÃ³ en cas de que conferencia no existeixi en el graf actual.
	 * @param label que es vol afegir
	 ...
	 * @param nom del paper a afegir
	 * @param label que tindrÃ  el paper
	 * @return el seu identificador intern
	 * @throws IOException si hi ha un error invalidant clausures
	 */
	 ...
	 *  LlenÃ§arÃ  una excepciÃ³ en cas de que paper no existeixi en el graf actual.
	 * @param label que es vol afegir
	...
	/**
	 * Modifica el nom dâ€™una conferencia
	...
	/**
	 * Consulta el nom dâ€™una conferencia.
	...
	/**
	 * Retorna si existeix la relaciÃ³ entre els dos nodes
	 * @param idPaper
	 * @param idAutor
	 * @return si existeix la relaciÃ³ entre els dos nodes
	 */
	 ...
	 * En cas de que hi haguÃ©s prÃ¨viament una altra relaciÃ³ entre aquests dos nodes 
	 * aquesta Ã©s eliminada ja que un paper nomÃ©s pot estar relacionat amb una conferÃ¨ncia.
	 * @param idPaper del paper
	 * @param idConferencia de la conferencia
	 * @return si ha sigut possible (si ambdos existeixen).
	 * @throws IOException si no es poden llegir/escriure els fitxers de clausures
	...
	/**
	 * Consulta totes les relacions dâ€™una conferencia.
	 * @param idConferencia de la conferencia
	 * @return una llista que contÃ© els noms de tots els papers relacionats.
	 */
	...
	/**
	 * Consulta totes les relacions dâ€™un autor.
	 * @param idAutor de l'autor
	 * @return una llista que contÃ© els noms de tots els papers relacionats.
	 */
	...
	/**
	 * Consulta totes les relacions dâ€™un terme.
	 * @param idTerme del terme
	 * @return una llista que contÃ© els noms de tots els papers relacionats.
	 */
	...
	/**
	 * Consulta totes les relacions dâ€™un paper amb autors.
	 * @param idPaper del paper
	 * @return una llista que contÃ© els noms dels autors relacionats amb el paper.
	 */
	...
	/**
	 * Consulta totes les relacions dâ€™un paper amb termes.
	 * @param idPaper del paper
	 * @return una llista que contÃ© els noms dels termes relacionats amb el paper.
	 */
	...
	/**
	 * Consulta totes les relacions dâ€™un paper amb conferencies.
	 * @param idPaper del paper
	 * @return una llista que contÃ© els noms de les conferencies relacionades amb el paper.
	 */
	...
	/**
	 * Modifica la definciÃ³ dâ€™un path 
	 * @param path
	...
	/**
	 * Retorna la definicio dâ€™un path
	 * @param path
	...
	/**
	 * Carrega tots els paths des dâ€™un fitxer.
	...
	/**
	 * Importa i crea un graf que tindrÃ  el nom donat mitjanÃ§ant els fitxers
	 * del directori que es passen com a parÃ metre (autors, papers, conferÃ¨ncies, 
	 * labels i relacions). Aquest graf sâ€™estableix com lâ€™actual. 
	 * El graf passa a ser el graf importat i idActual passarÃ  a ser nomGraf.
	 * @param nomGraf que Ã©s el nom del nou Graf importat
	 * @param directori on es troben els fitxers a patir dels quals es fa la importaciÃ³.
	 * @throws IOException en cas de que algun fitxer no tingui el format correcte 
	 * o bÃ© no sigui possible llegir-lo.
	 ...
	 * @param nomGraf que Ã©s el nom del Graf que es vol seleccionar.
	 * @return si ha sigut possible la selecciÃ³ del graf (el graf existia).
	 */
	...
	/** Retorna una llista amb els identificadors de tots els papers amb el nom del parÃ metre.
	 * @retrun Retorna una llista amb els identificadors de tots els papers amb el nom del parÃ metre.
	 */
	public List<Integer> consultarPaper(String nom){
		return controladorMultigraf.consultarPaper(nom);
	}

	/** Retorna una llista amb els identificadors de totes les conferÃ¨ncies amb el nom del parÃ metre.
	 * @retrun Retorna una llista amb els identificadors de totes les conferÃ¨ncies amb el nom del parÃ metre.
	 */
	public List<Integer> consultarConferencia(String nom){
		return controladorMultigraf.consultarConferencia(nom);	    
	}

	/** Retorna una llista amb els identificadors de tots els termes amb el nom del parÃ metre.
	 * @retrun Retorna una llista amb els identificadors de tots els termes amb el nom del parÃ metre.
	 */
	public List<Integer> consultarTerme(String nom){
		return controladorMultigraf.consultarTerme(nom);
	}

	/** Retorna una llista amb els identificadors de tots els autors amb el nom del parÃ metre.
	 * @retrun Retorna una llista amb els identificadors de tots els autors amb el nom del parÃ metre.
	 */
	...
	/** Consulta quantes conferÃ¨ncies hi ha en el graf actual.
	 * @return Retrona el nombre de conferÃ¨ncies del graf
	 */
	...
	/**
	 * Guarda totes les dades que es poden (fa una crida als mÃ¨todes de guardar grafs
	...
	/**
	 * Carrega totes les dades (fa una crida als mÃ¨todes de carregar grafs i 
