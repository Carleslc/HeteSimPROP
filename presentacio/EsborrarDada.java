		...
		btnEsborrar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (selectedID != null && selectedType != null) {
					...
					int n= JOptionPane.showOptionDialog(e.getComponent(), "Est�s segur d'esborrar aquesta dada?", "Est�s segur d'esborrar aquesta dada?", 
	...
	private void omplirTable() {
		...
		if (data != null) {
			for (Entry<Integer, String> i : data.entrySet()) {
				String[] row = {i.getKey().toString(), i.getValue(), "Informaci� Adicional"};
